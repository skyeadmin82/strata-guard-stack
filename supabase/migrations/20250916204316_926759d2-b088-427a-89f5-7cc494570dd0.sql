-- Fix SECURITY DEFINER views by recreating with SECURITY INVOKER mode
-- This ensures views respect RLS policies properly

-- Drop and recreate client_stats view with SECURITY INVOKER
...
-- Drop and recreate database_health_summary view with SECURITY INVOKER

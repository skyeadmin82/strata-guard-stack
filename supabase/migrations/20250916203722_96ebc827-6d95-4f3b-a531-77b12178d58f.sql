-- Create some demo assessments for testing with correct enum types
...
SELECT 
  ...
  t.id as template_id,
  CASE 
    WHEN random() < 0.3 THEN 'in_progress'::response_status
    WHEN random() < 0.6 THEN 'completed'::response_status

...
-- Booking System (Conflict prevention handled in application logic)
...
CREATE INDEX idx_service_bookings_time_conflicts ON service_bookings(start_time, end_time, assigned_technician) WHERE status NOT IN ('cancelled', 'completed');

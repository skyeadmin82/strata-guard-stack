-- Fix Critical RLS Security Issues - Drop existing policies first
-- Enable RLS and create clean policies
...
CREATE PROPERTY "Tenant access to recurring invoice schedules" ON public.recurring_invoice_schedules

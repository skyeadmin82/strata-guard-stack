...
-- Create sample scheduled assessments for demo (fixing assigned_to field to be text instead of UUID)
INSERT INTO public.scheduled_assessments (
  tenant_id, client_id, template_id, scheduled_date, notes, frequency, status
) VALUES 
('53ffcba2-59e1-4189-8271-600d5ada2a99', 'd2699670-5c3e-468e-9d7d-4925d5eaca1e', 'd59009a1-5d23-44fb-9980-e3d4fb73facc', 
 CURRENT_DATE + INTERVAL '7 days', 'Quarterly security assessment - assigned to IT Security Team', 'quarterly', 'scheduled'),
('53ffcba2-59e1-4189-8271-600d5ada2a99', '50345e5d-6339-4ac2-ae7c-e09a2eec687b', 'd59009a1-5d23-44fb-9980-e3d4fb73facc', 
 CURRENT_DATE + INTERVAL '14 days', 'Follow-up assessment after improvements - assigned to MSP Team', 'once', 'scheduled'),
('53ffcba2-59e1-4189-8271-600d5ada2a99', '84150132-4152-473d-87a6-9d1a5aa03da9', 'd59009a1-5d23-44fb-9980-e3d4fb73facc', 
 CURRENT_DATE + INTERVAL '30 days', 'Annual comprehensive review - assigned to Senior Analyst', 'annually', 'scheduled');

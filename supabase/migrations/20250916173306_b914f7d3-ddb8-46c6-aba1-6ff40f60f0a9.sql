...
-- 10. File upload relationships
ALTER TABLE file_uploads 
ADD CONSTRAINT fk_file_uploads_related_client 
FOREIGN KEY (related_entity_id) REFERENCES clients(id) ON DELETE CASCADE
WHERE related_entity_type = 'client';

-- 11. Workflow execution relationships
...
ALTER TABLE contacts ADD CONSTRAINT unique_client_primary_contact 
UNIQUE (client_id) WHERE is_primary = true;
